...
<figure>
    ...
    <figcaption>Como usualmente son vistos: una visión por nivel de detalle</figcaption>
</figure>
<p>Los casos de uso y las historias de usuario son similares porque ambas son formas de organizar requerimientos. Son diferentes
    en que organizan los requerimientos para diferentes propósitos. Los casos de uso organizan los requerimientos para formar
    una narrativa de cómo los usuarios se relacionan y usan un sistema. Por lo tanto, se centran en las metas de los usuarios
    y cómo la interacción con un sistema satisfacen las metas. En cambio, las historias de XP (y cosas similares, a menudo
    llamadas características) dividen los requerimientos en trozos (porciones, chunks) para fines de planificación. Las historias
    son explícitamente divididas hasta que se puedan estimar siendo parte del proceso de planificación del release de XP.
...
<p>Los dos tiene una correlación compleja. Las historias usualmente son de mayor grano fino (pequeñas) porque ellas tienen que
    ...
    a una historia; sin embargo una historia puede ser uno o más escenarios en un caso de uso (recuerdas los escenarios,
    uno donde todo sale bien y otros alternativos, donde quizá las cosas no salen bien), o uno o más pasos en un caso de
    uso. Una historia puede incluso no tener que mostrarse en la narrativa del caso de uso, por ejemplo agregar un nuevo
    método de depreciación de recursos a una lista emergente.</p>
<p>¿Necesitas ambas? Como en muchas cosas, en teoría sí pero en la práctica no. Algunos equipos podrían usar los casos de uso
    en un comienzo para construir una imagen narrativa (general), y luego para la planificación, las dividen en historias.
    Otros equipos van directamente a las historias. Otros podrían sólo hacer casos de uso y anotar su texto para mostrar
    cuando se desarrolla cada característica.</p>
<hr/>
<p>Espero que te haya gustado el articulo, cualquier corrección o mejora en la traducción escribirme en los comentarios, desde
    ya gracias :)</p>
<p>Ahh.. y si te gustaría saber más opiniones de otras personas y gurús del desarrollo de software, te dejo los mejores artículos
    que encontré.</p>
