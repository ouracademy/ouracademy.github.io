...
export default () => (
  <Post
    post={{
      ...
      image:
        'https://cdn-images-1.medium.com/max/600/1*leQKaSU-kcILOMBEtXcrBg.png',
      description:
        'Cual es la diferencia entre Casos de uso y las Historias de Usuario de Extreme Programming (XP)?',
